...
{
    /**
     * Display the personal progress view for "Personal leadership" competence for Year 4.
     *
     * @return \Illuminate\View\View
     */
    public function index()
    {
        // Dummy data for progress on each element of "Personal leadership"
        // In a real application, this data would come from a database,
        // user input, or a scoring system specific to Year 4.
        $elementsProgress = [
            [
