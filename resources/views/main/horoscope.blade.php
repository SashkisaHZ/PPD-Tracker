...
<div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 h-screen">
    ...
    <div class="md:col-span-2 flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-4 relative overflow-hidden">
        <!-- Faded background image -->
        <div class="absolute inset-0 flex items-center justify-center opacity-10"
             style="background-image: url('{{ asset('images/Horoscope.png') }}'); background-size: contain; background-repeat: no-repeat; background-position: center; filter: invert(1);">
        </div>

        <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center z-10">
            Let's see if the planets<br>are on your side
        </h2>

        <div class="bg-gray-100 p-8 rounded-lg shadow-inner w-full max-w-md text-center mb-8 z-10" style="min-height: 120px;">
            <p class="text-gray-600 text-lg italic">Horoscope text here</p>
            <div class="border-b-2 border-gray-400 mt-4 mx-auto w-3/4"></div> <!-- Dashed line effect -->
        </div>

        <button class="bg-blue-600 text-white py-3 px-8 rounded-lg shadow-md hover:bg-blue-700 transition duration-200 ease-in-out text-xl font-bold z-10">
            Generate
        </button>
    </div>
</div>
